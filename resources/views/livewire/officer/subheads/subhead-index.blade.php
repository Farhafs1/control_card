    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
            ...
            <div class="flex items-center gap-2 mt-1">
                <span class="px-2 py-0.5 bg-emerald-100 text-emerald-800 text-[9px] font-bold rounded-full uppercase tracking-widest">Officer View</span>
                <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Managing Your Portfolio</p>
            </div>
        </div>
